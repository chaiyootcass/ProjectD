...
?>
	...
	<div class="container" style="margin-top: 70px; margin-bottom: 40px;">
		...
		<form name="form1" style="padding-left: 25%;" action="add_bus.php" method="POST" onsubmit="return required()">
			...
			<div class="form-group">
			    <label class="text-white">Total seats in bus:</label>
			    <br>
			...
			<div class="form-group">
			    <label class="text-white">Source station:</label>
			    <br>
			...
			<label class="text-white"> Intermediate Stations:</label>
			...
			<div class="form-group" id="std01"style="display: none;">
			    <label class="text-white">Intermediate station 1</label>
			    <br>
			...
			<div class="form-group" id="std02"style="display: none;">
			    <label class="text-white">Intermediate station 2</label>
			    <br>
			...
			<div class="form-group" id="std03"style="display: none;">
			    <label class="text-white">Intermediate station 3</label>
			    <br>
			...
			<div class="form-group" id="std04"style="display: none;">
			    <label class="text-white">Intermediate station 4</label>
			    <br>
			...
			<div class="form-group" id="std05"style="display: none;">
			    <label class="text-white">Intermediate station 5</label>
			    <br>
			...
			<div class="form-group" id="std06"style="display: none;">
			    <label class="text-white">Intermediate station 6</label>
			    <br>
			...
			<div class="form-group" id="std07"style="display: none;">
			    <label class="text-white">Intermediate station 7</label>
			    <br>
			...
			<div class="form-group" id="std08"style="display: none;">
			    <label class="text-white">Intermediate station 8</label>
			    <br>
			...
			<div class="form-group" id="std09"style="display: none;">
			    <label class="text-white">Intermediate station 9</label>
			    <br>
			...
			<label id="count_intermediate " class="text-white">0</label>
			...
			<div class="form-group">
			    <label class="text-white">Destination station:</label>
			    <br>
